image:https://circleci.com/gh/NoEnv/vertx-wiremongo.svg?style=svg["Build Status",link="https://circleci.com/gh/NoEnv/vertx-wiremongo"]
...
----
compile 'com.noenv:vertx-wiremongo:3.9.4'
----
...
To test this class, simply create an instance of `WireMongoImpl`, set up some mocking using its fluent methods, and use it as the `MongoClient` implementation in your tests:
